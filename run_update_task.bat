...
REM PYTHONPATHを設定してsrcディレクトリをモジュール検索パスに追加
set PYTHONPATH=%CD%
...
REM python\python.exe -m src.main --single-run --prod >> %LOG_FILE% 2>&1
python\python.exe src\main.py --single-run --prod >> %LOG_FILE% 2>&1
